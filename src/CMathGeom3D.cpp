...
bool
CMathGeom3D::
LineLineIntersect(const CPoint3D &p1, const CPoint3D &p2, const CPoint3D &p3, const CPoint3D &p4,
                  CPoint3D &pa, CPoint3D &pb, double &mua, double &mub)
{
  CPoint3D p13, p43, p21;
  ...
  if (std::abs(p43.x) < CMathGen::EPSILON_E6 &&
      std::abs(p43.y) < CMathGen::EPSILON_E6 &&
      std::abs(p43.z) < CMathGen::EPSILON_E6)
    return false;
  ...
  if (std::abs(p21.x) < CMathGen::EPSILON_E6 &&
      std::abs(p21.y) < CMathGen::EPSILON_E6 &&
      std::abs(p21.z) < CMathGen::EPSILON_E6)
    return false;
  ...
  if (std::abs(denom) < CMathGen::EPSILON_E6)
    return false;
