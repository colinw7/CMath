...
namespace CMathGeom2D {
  ...
  bool IntersectPolygons(const int *x1, const int *y1, uint n1,
  ...
  bool CutPolygon(const std::vector<CPoint2D> &points, const CBBox2D &bbox,
  ...
  double PolygonArea(const int *x, const int *y, uint num_xy);
  ...
  double PolygonArea2(const int *x, const int *y, uint num_xy);
  ...
  void PolygonCentroid(const int *x, const int *y, int num_xy, int *xc, int *yc);
